...
const FALLBACK_EMAIL = "hadiikhan767@gmail.com";
const FALLBACK_WHATSAPP = "+923454029727";
...
export default function Footer({ profile }: FooterProps) {
  ...
  const name     = profile?.name    ?? "Hammad Daud";
  ...
  const socialLinks = [
    { Icon: LinkedinIcon, label: "LinkedIn", href: socials?.linkedin ?? "https://www.linkedin.com/in/hammad-daud-427767231" },
    { Icon: UpworkIcon,   label: "Upwork",   href: socials?.upwork   ?? "https://www.upwork.com/freelancers/~0130b7935de07c34ef?mp_source=share" },

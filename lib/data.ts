...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/ColorArrowDodge.jpeg",
    tags: ["2D", "Mobile"],
    techStack: ["Unity", "C#", "AdMob", "AppLovin", "Firebase"],
    description:
      "A colorful brain game challenging you to think before you tap. Clear the entire board by removing arrows in the correct order. Every arrow follows its own direction, and one wrong choice can stop the flow. Watch the routes, plan ahead, and make your move at the perfect time.",
    links: {
      playStore: "https://play.google.com/store/apps/details?id=com.GameNock.ArrowDodge",
      appStore: "https://apps.apple.com/us/app/color-arrow-dodge/id6758392154",
    },
    isFeatured: false,
  ...
  {
    id: 7,
    title: "Jigsaw HD Solitaire Puzzle",
    image: "/Jigsaw.jpeg",
    tags: ["2D", "Mobile"],
    techStack: ["Unity", "C#", "AdMob", "AppLovin", "Firebase"],
    description:
      "A beautifully designed picture-sorting puzzle game where every level challenges you to drag, place, and solve scattered parts of an image. Turn unsorted picture grids into stunning masterpieces at your own pace or challenge yourself with timer mode.",
    links: {
      playStore: "https://play.google.com/store/apps/details?id=com.GameNock.JigsawHDsolitairepuzzle",
      appStore: "https://apps.apple.com/us/app/jigsaw-hd-solitaire-puzzle/id6745785150",
    },
    isFeatured: false,
  ...
  {
    id: 8,
    title: "BankHeist: Robbery Escape",
    image: "/Bankheist.jpeg",
    tags: ["3D", "Mobile"],
    techStack: ["Unity", "C#", "AdMob", "AppLovin", "Firebase"],
    description:
      "Step into the sneaky paws of a clever fox in a thrilling stealth-action game! Infiltrate high-security bank floors, dodge patrolling guards, and loot hidden treasures without getting caught. Move swiftly through rooms and hide behind furniture to make the heist a success.",
    links: { appStore: "https://apps.apple.com/us/app/bank-heist-robbery-escape/id6746856663" },
    isFeatured: false,
    gradient: "from-slate-900 via-zinc-950 to-slate-900",
    accentColor: "#f97316",
    year: "2025",
  },
  {
    ...
    image: "/bunnyhasabomb.jpeg",
    tags: ["3D", "Mobile"],
    techStack: ["Unity", "C#", "AdMob", "AppLovin", "Firebase"],
    description:
      "Designed for users who love to race through open forest fields. Enjoy crazy race rush mechanics with a bomb twist! Players need to switch the bomb to their companion cartoon characters during the race to knock them out of the game.",
    links: {
      playStore: "https://play.google.com/store/apps/details?id=com.gamenock.bunnyhasthebomb.racinggame.kartgame.driftgame",
      appStore: "https://apps.apple.com/us/app/bunny-has-a-bomb-race-rush/id6745409902",
    },
    isFeatured: false,
    gradient: "from-green-950 via-lime-950 to-slate-900",
    accentColor: "#22c55e",
    year: "2025",
  },
  {
...
export const experience = [
  {
    ...
    location: "Remote",
    description:
      "Leading game development initiatives at Gamenock, designing and delivering high-quality game experiences across multiple platforms. Responsible for end-to-end development, team collaboration, and maintaining scalable, performant codebases.",
    tech: ["Unity 3D", "C#", "Game Design", "Multiplayer", "Mobile", "PC"],
    type: "Full-time",
  },
  {
    ...
    description:
      "Unity developer on Upwork with a 100% Job Success Score. Delivering multiplayer titles, mobile casual games, 3D simulations, blockchain apps, and WebGL experiences for international clients, consistently rated 5 stars across all engagements.",
...
export const testimonials = [
  {
    ...
    content:
      "Hammad was excellent to work with throughout the project. He was professional, communicative, detail-oriented, and consistently delivered high-quality work. He successfully implemented gameplay features, UI improvements, ad mediation, Firebase integration, and bug fixes. Communication was clear throughout the process, and the final result exceeded my expectations.",
    rating: 5,
    initials: "AD",
    gradientFrom: "#3b82f6",
    gradientTo: "#8b5cf6",
  },
  {
    ...
    content:
      "This is the 2nd major project I have worked on with Hammad. He was an absolute integral part of the project. He was able to make all of my ideas come true, and he did it with a high level of efficiency and skill. I especially appreciate his attention to detail. He is a gem of a scripter, extremely talented, and a wonderful Unity developer.",
    rating: 5,
    initials: "KA",
    gradientFrom: "#8b5cf6",
    gradientTo: "#6d28d9",
  },
  {
    ...
    project: "Mining App",
    content:
      "I had a great experience working with Hammad Daud on my app. From the start, he understood my requirements and turned them into a working product exactly the way I imagined. He communicates clearly, gives useful suggestions, and always responds quickly.",
    rating: 5,
    initials: "SH",
    gradientFrom: "#10b981",
    gradientTo: "#059669",
  },
  {
    ...
    project: "Card Game",
    content:
      "I highly recommend Hammad Daud for game development needs. He delivered the card game on schedule and within budget. He was also very responsive to my questions and concerns, and he quickly resolved any issues that arose during testing.",
    rating: 5,
    initials: "TT",
    gradientFrom: "#0ea5e9",
    gradientTo: "#6366f1",
  },
  {
    ...
    content:
      "Hammad did a great job designing my Mobil Directo Siren 3D model for Roblox. It had a realistic control panel and fire coming out of its exhaust. Hammad patiently worked with me to make sure that the sound problem was fixed. I highly recommend this freelancer.",
    rating: 5,
    initials: "TB",
    gradientFrom: "#f59e0b",
    gradientTo: "#ef4444",
  },
  {
    ...
    content:
      "I had a particularly challenging job, and Hammad was able to sort the issue and get everything solved. Really appreciate the effort he put into my project! Thank you!",
    rating: 5,
    initials: "KA",
    gradientFrom: "#ec4899",
    gradientTo: "#8b5cf6",
